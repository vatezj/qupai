...
return [
    ...
    'qu' => [
        'driver' => env('DB_QU_DRIVER', 'mysql'),
        'host' => env('DB_QU_HOST', 'localhost'),
        'port' => env('DB_QU_PORT', 3306),
        'odbc' => env('ODBC_ENABLE', false),
        'odbc_datasource_name' => env('ODBC_DSN'),
        'database' => env('DB_QU_DATABASE', 'hyperf'),
        'username' => env('DB_QU_USERNAME', 'root'),
        'password' => env('DB_QU_PASSWORD'),
        'charset' => env('DB_QU_CHARSET', 'utf8mb4'),
        'collation' => env('DB_QU_COLLATION', 'utf8mb4_unicode_ci'),
        'prefix' => env('DB_QU_PREFIX', ''),
        'pool' => [
            'min_connections' => 1,
            'max_connections' => 20,
            'connect_timeout' => 10.0,
